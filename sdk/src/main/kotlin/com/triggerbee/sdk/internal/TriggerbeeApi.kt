 ...
 * the `/v2/client/` prefix and are authenticated by the `X-Application-Id` header (matched
...
internal interface TriggerbeeApi {
    ...
    @POST("/v2/client/events/{uid}/goal")
    suspend fun goal(
        @Header("X-Site-Id") siteId: Long,
        @Path("uid") uid: Long,
    ...
    @POST("/v2/client/events/{uid}/pageview")
    ...
    @POST("/v2/client/events/{uid}/purchase")
    ...
    @POST("/v2/client/events/{uid}/batch")
    suspend fun batch(
        @Header("X-Site-Id") siteId: Long,
        @Path("uid") uid: Long,
